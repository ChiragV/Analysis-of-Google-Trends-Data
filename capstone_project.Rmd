...
### Step 3 : Plotting 
Plotting Bit coin search Trends v/s price 
...
Result shows most searched "How to.." queries on Google. The clouds give greater prominence to words that appear more frequently. <br />

- Good to see "how to vote" as in 2016 as being election year.
- "How to tie" query is present in all years.
- In 2012, we used to search like "how to boil eggs" ,"how to make pancackes" and "how to make french braid". In 2017, we still ask these questions but we ask more about losing weight , blocking number and more about iphone, mac and instagram.

<hr style="border: 2px solid #357FAA;"/>

# Unique "How to.." search (editor's choice ;) )
...
To do : when we mouse hover it shows some value, which is wrong. I am working on it.


### How to handle wife

Out of above unique "How to" queries, I found "How to handle wife" quite funny and seriouls at the same time.
