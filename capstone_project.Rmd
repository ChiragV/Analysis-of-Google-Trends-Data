...
Todo: when we mouse hover, along with text it shows some value, which is wrong.
...
```{r}
pregnantWomenEat<- function(query1,geo1)
{
...
<td style="vertical-align:top">`r pregnantWomenEat("Can pregnant women eat", "US")`</td>
<td style="vertical-align:top">`r pregnantWomenEat("Can pregnant women eat", "GB")`</td>
<td style="vertical-align:top">`r pregnantWomenEat("Can pregnant women eat", "AU")`</td>
</tr>
</table>


#How to during pregnancy
...
states2 <- read.csv('US_States.csv', stringsAsFactors = FALSE)
